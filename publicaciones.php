...
$CantidadMostrar = 5;
	...
	<!-- START PUBLICACIONES -->
          ...
          <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle img-sm" src="avatars/<?php echo $use['avatar']; ?>" alt="User Image">
                <b><span class="description" onclick="location.href='perfil.php?id=<?php echo $use['id_use']; ?>';" style="cursor:pointer; color: #ee0de6;"><?php echo $use['usuario']; ?></span></b>
            ...
            <div class="box-body">
              ...
              if (in_array($extf, $extfotos)) {
                  ?>
				        <img src="<?php echo $fot['ruta']; ?>" width="100%">
              <?php
              } elseif (in_array($extf, $extaudio)){ ?>
                <br><br>
				        <audio src="<?php echo $fot['ruta']; ?>" preload="metadata" width="100%" controls>
                <br>
              <?php
              } else { ?>
                <video src="<?php echo $fot['ruta']; ?>" preload="metadata" width="100%" controls>
              <?php
              } ?>
              <br><br>
              <?php
        ...
        if (mysqli_num_rows($query) == 0) {
            ...
            <?php
            $comentarios = mysqli_query($connect, "SELECT * FROM comentarios WHERE publicacion = '".$lista['id_pub']."' ORDER BY id_com desc LIMIT 4");
