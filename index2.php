            ...
            <div class="col-md-12">              
              ...
              <!-- /.box-body -->
                <div class="box-footer">
                  <form action="https://fileserver1.venussr.com/upload.php" method="post" enctype="multipart/form-data">
                    ...
                    <!-- START Input file nuevo diseño .-->
                      <input type="file" name="archivo[]" id="archivo[]" class="inputfile inputfile-1" multiple="multiple" data-multiple-caption="{count} files selected" accept="image/*,video/*,audio/*" required/>
