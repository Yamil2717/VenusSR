          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <?php
                ...
                <br><br>
				        <audio src="publicaciones/<?php echo $fot['ruta']; ?>" preload="metadata" width="100%" controls>
                <br>
              <?php
              } else { ?>
                <video src="publicaciones/<?php echo $fot['ruta']; ?>" preload="metadata" width="100%" controls>
              <?php
              } ?>
              <br><br>
              <?php 
